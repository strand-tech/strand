...
Here is how we would run the simulation discussed in the package vignette:
...
2. With the same working directory in R, create a simulation object configured using the vignette example's yaml file:
```{r}
library(strand)
